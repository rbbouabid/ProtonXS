...
// Fri Feb 17 01:54:48 2017 by ROOT version 6.06/08
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //Double_t        trkpitch[9][2];   //[ntracks_reco]
   Double_t        trkpitch[11][2];   //[ntracks_reco]
   Int_t           no_primaries;
...
#ifdef scratch_cxx
scratch::scratch(TTree *tree) : fChain(0) 
{
...
Int_t scratch::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t scratch::LoadTree(Long64_t entry)
{
...
void scratch::Show(Long64_t entry)
{
...
Int_t scratch::Cut(Long64_t entry)
{
...
double scratch::distance(double a[], double b[])
  {
...
bool scratch::is_in_tpc(int spc_pt)
  {
...
double scratch::get_angle(double a[], double b[])
  {
...
int scratch::get_primary(double mc_tpc_x, double mc_tpc_y, double mc_vx, double mc_vy, double mc_vz)
  {
  int primary = 999;
...
int scratch::get_primary_track_id()
  {
...
int scratch::get_primary_process()
  {
